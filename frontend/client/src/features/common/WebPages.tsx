 ...
 * @param {string} idPrefix prefix for ExternalLink ids (defaults to the
 *   historical person-group id so existing callers keep their ids)
 */
const WebPages: React.FC<{
  webPages: Array<string>
  idPrefix?: string
}> = ({ webPages, idPrefix = 'person-group-web-page' }) => {
