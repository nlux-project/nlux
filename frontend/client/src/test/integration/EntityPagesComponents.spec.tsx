...
describe('Entity pages relationship components', () => {
  ...
  describe('Timeline', () => {
    ...
    it('renders the year search link with correct href', async () => {
      ...
      expect(link).toHaveAttribute(
        'href',
        `/view/results/objects?q=%7B%22AND%22%3A%5B%7B%22producedBy%22%3A%7B%22id%22%3A%22https%3A%2F%2Fendpoint.yale.edu%2Fdata%2Fperson%2Fmock-person-1%22%7D%7D%2C%7B%22producedDate%22%3A%221983-12-31T00%3A00%3A00.000Z%22%2C%22_comp%22%3A%22%3C%3D%22%7D%2C%7B%22producedDate%22%3A%221983-01-01T00%3A00%3A00.000Z%22%2C%22_comp%22%3A%22%3E%3D%22%7D%5D%7D&searchLink=true`,
      )
    })
  })
