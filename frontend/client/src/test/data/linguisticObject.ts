...
export const linguisticObject: IObject = {
  ...
  _links: {
    ...
    'lux:workCarriedBy': {
      href: `${config.env.dataApiBaseUrl}api/search/item?q=%7B%22AND%22%3A%5B%7B%22carried%22%3A%7B%22id%22%3A%22https%3A%2F%2Fendpoint.yale.edu%2Fdata%2Ftext%2Fmock-linguistic-object%22%7D%7D%5D%7D`,
      _estimate: 1,
    },
  },
}
