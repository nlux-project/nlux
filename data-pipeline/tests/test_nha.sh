...
TEST_NHA_C1477_ID="65B76D9AFB8F11DF9E4D523BC2E286E2" NHA_C1477_REQUIRE_LIVE=1 \
    uv run python -m unittest "tests.test_nha_pipeline.NhaC1477PipelineIntegrationTest.test_fetcher_builds_filtered_memorix_requests"
TEST_NHA_C1477_ID="65B76D9AFB8F11DF9E4D523BC2E286E2" NHA_C1477_REQUIRE_LIVE=1 \
    uv run python -m unittest "tests.test_nha_pipeline.NhaC1477PipelineIntegrationTest.test_mapper_transforms_record_with_c1477_collection_label"
