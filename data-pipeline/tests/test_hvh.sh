...
/bin/bash "$SCRIPT_DIR/test_hvh-pipeline.sh" 4564-09

# ----------------------------------------
# Test: Pseudo-muntfibula/bracteatenfibula
# ----------------------------------------
# /Users/lux/data-pipeline/data/input/hvh/5061-06.json
/bin/bash "$SCRIPT_DIR/test_hvh-pipeline.sh" 5061-06

# ----------------------------------------
# Test API search and resolvable references
# ----------------------------------------
TEST_PRIREF="4564-09" HVH_REQUIRE_LIVE=1 \
    $TEST_PY -m unittest "tests.test_hvh_pipeline.HvhPipelineIntegrationTest.test_api_record_has_resolvable_collection_and_owner"

TEST_PRIREF="4564-09" HVH_REQUIRE_LIVE=1 \
    $TEST_PY -m unittest "tests.test_hvh_pipeline.HvhPipelineIntegrationTest.test_api_search_finds_collection_and_owner"
...
HVH_REQUIRE_LIVE=1 \
    $TEST_PY -m unittest "tests.test_hvh_pipeline.HvhPipelineIntegrationTest.test_api_hvh_collection_record"
...
HVH_REQUIRE_LIVE=1 \
    $TEST_PY -m unittest "tests.test_hvh_pipeline.HvhPipelineIntegrationTest.test_api_hvh_owner_group_record"
